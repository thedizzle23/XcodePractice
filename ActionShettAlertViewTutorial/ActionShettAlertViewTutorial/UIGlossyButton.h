...
@property (nonatomic, strong) UIColor *disabledColor;   // color when disabled, can be nil for lightgray color when disabled
...
@property (nonatomic, strong) UIColor *borderColor;	// button border color, default nil = dark gray
@property (nonatomic, strong) UIColor *disabledBorderColor;   // color when disabled, can be nil for lightgray color when disabled
